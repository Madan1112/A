...
BOT_TOKEN = "8150713241:AAFZE54DVoLcfXKlaSN1tOOqUvFiaRvZFik"
CHANNEL_ID = ["-1002485757318"]
OWNER_ID = {5050566312}  # Replace with your owner IDs
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not await is_user_in_all_channels(user_id, context):
        await update.message.reply_text(
            ...
            "1. [Channel 1](https://t.me/+nulh4rw44YcwYWRl)\n"
            "2. [Channel 2](https://t.me/+nulh4rw44YcwYWRl)",
            parse_mode="Markdown",
        )
    else:
